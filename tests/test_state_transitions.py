...
# Common test for when only Red, Refactor, Merge and Beige should be allowed

def _check_only_red_refactor_merge_beige_states_are_allowed(current):
    assert allowed(current, Kind.initial) is False
    assert allowed(current, Kind.green) is False
...
def test_states_allowed_after_green():
    _check_only_red_refactor_merge_beige_states_are_allowed(Kind.green)


# What is allowed after 'refactor'?

def test_states_allowed_after_refactor():
    _check_only_red_refactor_merge_beige_states_are_allowed(Kind.refactor)


# What is allowed after 'merge'?

def test_states_allowed_after_merge():
    _check_only_red_refactor_merge_beige_states_are_allowed(Kind.merge)


# What is allowed after 'beige'?

def test_states_allowed_after_beige():
    _check_only_red_refactor_merge_beige_states_are_allowed(Kind.beige)
